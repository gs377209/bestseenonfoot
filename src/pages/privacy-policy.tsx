...
export default function PrivacyPolicy({ allPosts }: Props) {
  const titleText = `Privacy Policy | Best Seen on Foot`;
        ...
        <section className="container prose mx-auto mb-32 max-w-none md:prose-lg lg:col-span-2 lg:prose-xl">
          ...
          <article>
            ...
            <p>
              ...
              <Link href="/">
                <a>https://www.bestseenonfoot.com</a>
              </Link>
            </p>
            ...
            <p>
              If you use our contact form or email us, the information and its
              metadata are retained indefinitely. This is done purely for
            ...
            <p>
              If you have contacted us, you can request to receive an exported
              file of the personal data we hold about you, including any data
              ...
              are obliged to keep for administrative, legal, or security
              purposes.
            </p>
